...
## 🎯 Fonctions Clés
- **Scoring dynamique :** indice composite basé sur 4 piliers (solvabilité, liquidité, stabilité, inflation).
- **Moteur prédictif (ML) :** modélisation de séries temporelles pour anticiper les trajectoires de risque à 6 mois.
- **Interface institutionnelle :** design minimaliste inspiré des terminaux financiers.
